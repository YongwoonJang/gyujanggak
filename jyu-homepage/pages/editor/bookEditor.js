        ...
        <>  
            <div className={bookEditorStyle.container}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className={bookEditorStyle.row}>
                        <input type="submit" value={props.selectBook == null ? "New" : "Edit"} />
                    </div>
                    <InputGroup
                        errors={errors.title}
                        isTextarea={false}
                        ...
                        value={props.selectBook === null ? "" : props.selectBook.title}
                        setValue={setValue}
                    />
                    <InputGroup
                        ...
                        value={props.selectBook === null ? "" : props.selectBook.subtitle}
                        setValue={setValue}
                    />
                    <InputGroup
                        ...
                        value={props.selectBook === null ? "" : props.selectBook.author}
                        setValue={setValue}
                    />
                    <InputGroup
                        ...
                        value={props.selectBook === null ?"":props.selectBook.publishDate}
                        setValue={setValue}
                    />
                    <InputGroup 
                        ...
                        value={props.selectBook === null ? "" : props.selectBook.review}
                        setValue={setValue} 
                    />
                    <InputGroup
                        errors={errors.image}
                        ...
                        value={props.selectBook === null ? "" : props.selectBook.image}
                        setValue={setValue}
                    />
                </form>
            </div>
